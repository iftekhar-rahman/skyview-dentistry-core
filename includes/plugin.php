...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Go_Digital_Addon\Plugin The single instance of the class.
	 */
	...
	public function my_plugin_frontend_scripts() {
		...
		wp_register_script( 'slick-js', plugins_url( '/assets/js/slick.min.js', __FILE__ ), [ 'jquery' ], '', true );
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'go-digital',
			[
				'title' => esc_html__( 'Go Digital', 'go-digital-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		$widgets_manager->register( new \Skyview_Dentistry_Addon\Services() );
